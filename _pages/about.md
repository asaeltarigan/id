...
seo_title: "Gabriel Asael Tarigan | Dosen AI (Kecerdasan Buatan) di BINUS University"
author_profile: true
redirect_from:
  - /tentang/
  - /tentang.html
...
* **Build Diary**: [repositori publik otomatis](https://github.com/asaeltarigan/build-diary) yang mendokumentasikan rilis produksi mingguan dan eksperimen teknis.

## Publikasi Terpilih

Daftar lengkap dengan metrik sitasi tersedia di [Google Scholar](https://scholar.google.com/citations?user=FCaQ7i0AAAAJ), [ResearchGate](https://www.researchgate.net/profile/Gabriel-Asael-Tarigan), dan halaman [Publikasi](/publikasi/). Judul dan venue dipertahankan dalam bahasa asli sesuai standar akademik.
